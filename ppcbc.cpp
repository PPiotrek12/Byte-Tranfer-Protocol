...
using namespace std;
const uint64_t DATA_PACKET_SIZE = 100; // TODO
...
void send_one_DATA_packet(int socket_fd, struct sockaddr_in server_address, uint64_t ses_id, uint64_t packet_nr, uint32_t bytes_nr, char *data) {
